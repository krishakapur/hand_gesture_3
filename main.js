...
classifier = ml5.imageClassifier('https://teachablemachine..withgoogle.com/models/vO-dlQp4A/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "Boo"){
            document.getElementById("result_emoji").innerHTML = "&#9994;";
            document.getElementById("quote").innerHTML = "You could do better";
        }
        ...
        if(results[0].label == "Point"){
            document.getElementById("result_emoji").innerHTML = "&#129304;";
            document.getElementById("quote").innerHTML = "Look up";
        }
